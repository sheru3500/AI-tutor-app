...
def generate_response(prompt):
    bard = Bard(token='agiG1N7RoLgc9fC0jVYW6WqUT_nN-3HgZFRZvtu4Yq1Kzwhir-Rj9QuIjKsrs_-VADXAmQ.')
...
[data-testid = "stAppViewContainer"]
    {
    background-image:url('https://images.unsplash.com/photo-1497294815431-9365093b7331?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80');
    background-size:cover;
    }
    
    div.e1f1d6gn2 > iframe {
